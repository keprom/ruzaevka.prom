...
<table width=100% border=1px cellspacing=0px style="border: black;font-family: Verdana; font-size: x-small;">
 ...
 <td rowspan=3 width=110px>По ср. отпускному тарифу (с НДС 22,06)
 </td>
...
$buf_sum_otp_nds=($buf_vsego_kvt)*22.06;
...
<td>
 ...
 <th align=right>
  <b><?php echo f_d($vsego_kvt*22.06);?></b>
 </th>
 <th align=right>
  <b><?php echo f_d($sum_with_nds-($vsego_kvt*22.06));?></b>
 </th>
