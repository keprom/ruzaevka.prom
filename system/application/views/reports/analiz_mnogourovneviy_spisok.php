...
<table width=100% border=1px cellspacing=0px style="border: black;font-family: Verdana; font-size: x-small;">
 ...
 <td rowspan=3 width=110px>По ср. отпускному тарифу (с НДС 14,73)
 </td>
...
$sum_otp_nds+=($d->itogo_kvt_ur1+$d->itogo_kvt_ur2+$d->itogo_kvt_ur3)*14.73;
...
$_sum_otp_nds+=($d->itogo_kvt_ur1+$d->itogo_kvt_ur2+$d->itogo_kvt_ur3)*14.73;
...
<td>
	<?php echo f_d(($d->itogo_kvt_ur1+$d->itogo_kvt_ur2+$d->itogo_kvt_ur3)*14.73);?>
</td> 

<td>
	<?php echo f_d((($d->tenge_ur1+$d->tenge_ur2+$d->tenge_ur3)*($d->nds+100)/100)-(($d->itogo_kvt_ur1+$d->itogo_kvt_ur2+$d->itogo_kvt_ur3)*14.73));?>
</td> 
 ...
 <td align=right>
  ...
  <td align=right>
  <b><?php echo f_d($sum_1ur_tenge+$sum_2ur_tenge+$sum_3ur_tenge);?></b>
 </td>
 <td align=right>
  <b><?php echo f_d($sum_with_nds);?></b>
 </td>
