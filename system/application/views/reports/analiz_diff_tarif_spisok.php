...
<table width=100% border=1px cellspacing=0px style="border: black;font-family: Verdana; font-size: x-small;">
 ...
 <td rowspan=3 width=110px>По ср. отпускному тарифу (с НДС 22,26)
 </td>
 ...
 <tr align=center>
 <td colspan=2>
  По тарифу дневной (19,70)
 </td>
 <td colspan=2>
  По тарифу ночной (6,77)
 </td>
 <td colspan=2>
  По тарифу вечерний (51,01)
 </td>
 </tr>
 <tr>
 <td >
...
$sum_otp_nds+=($d->itogo_kvt_day+$d->itogo_kvt_night+$d->itogo_kvt_evening)*22.06;
...
$_sum_otp_nds+=($d->itogo_kvt_day+$d->itogo_kvt_night+$d->itogo_kvt_evening)*22.06;
...
<td>
	<?php echo f_d(($d->itogo_kvt_day+$d->itogo_kvt_night+$d->itogo_kvt_evening)*22.06);?>
</td> 

<td>
	<?php echo f_d((($d->tenge_day+$d->tenge_night+$d->tenge_evening)*($d->nds+100)/100)-(($d->itogo_kvt_day+$d->itogo_kvt_night+$d->itogo_kvt_evening)*22.06));?>
</td> 
 ...
 <tr align=center>
<td > Директор ф-ала Рузаев-Энерго </td>
<td> <?php echo $org->director;?></td>
</tr><tr></tr><tr></tr>
 <tr align=center>
<td > Зам. Директора по сбыту</td>
<td> <?php echo $org->nachalnik_otdela_sbyta;?></td>
</tr>
