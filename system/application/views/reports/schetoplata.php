...
if (strlen($data_schet)==0){ echo datetostring($schetfactura_date->date);} else { echo $data_schet;}?>
 ...
 <tr>
 <td width=2100px> Товарно-транспортная накладная №_____   от ________________</td><td> (7)</td>
 </tr>
 <tr>
 <td width=2100px> Грузоотправитель <u><?php echo "БИН ".$org->bin.", ".$org->org_name.", ".$org->address;?>   </u></td>
 <td> (8)</td>
 </tr>
 <tr align=right>
 ...
 <tr>
 <td width=2100px> Грузополучатель  <u><?php echo $firm->bin.", ".$firm->name.", <br/>".$firm->address;?>          </u>   </td>
 <td> (9)</td>
 </tr>
 <tr align=right>
 <td width=2100px><i><FONT size=1>(РНН, наименование и адрес места нахождения)                                                                                                                        </font></i></td>
...
<?php endfor;?>
 ...
 <?php echo num2str(f_d2($sum_bez_nds + $sum_nds));?>
	...
	<tr>
	<td align=left><?php echo $org->director; ?>____________</td><td align=right>Ведущий инженер <u>Бодня М.А.</u></td>
	</tr>
	<tr>
	...
	<br>
	<tr align=left>
	<td width='2100px'>Примечание. Без печати недействительно.Оригинал (первый экземпляр)-покупателю.Копия (второй экземпляр)-поставщику.</td>
	</tr>
