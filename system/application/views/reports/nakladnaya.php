...
<tr align=center><td>
 ...
 <b>№</b> <?php echo '0'.$schetfactura_date->schet_new.' от ';
...
<tr><td></td></tr>
<tr>
<td align="left">Отпустил Зам.директора по сбыту:</td>
<td align="right"> <?php echo trim($org->nachalnik_otdela_sbyta); ?></td>
<td></td>
</tr>
<tr><td></td></tr>
 <tr>
 <td align="left">Уполномоченный на подписание счета-фактуры<br/>за директора:Зам.директора по сбыту:</td>
 <td align="right"> Куркин Ю.Ю.</td><td></td>
 </tr>
 <tr><td></td></tr>
 <tr>
 <td align="right">За гл.бухгалтера: бухгалтер-кассир:</td>
 <td align="right"> Гергенрейдер З.А.</td><td></td>
 </tr>
