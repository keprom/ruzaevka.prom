...
{
	$d=explode("-",$date); 
	if ($d['1']==1) {$d['1']='31 января';}
	if ($d['1']==2) {$d['1']='28 февраля';}
	if ($d['1']==3) {$d['1']='31 марта';}
	if ($d['1']==4) {$d['1']='30 апреля';}
	if ($d['1']==5) {$d['1']='31 мая';}
	if ($d['1']==6) {$d['1']='30 июня';}
	if ($d['1']==7) {$d['1']='31 июля';}
	if ($d['1']==8) {$d['1']='31 августа';}
	if ($d['1']==9) {$d['1']='30 сентября';}
	if ($d['1']==10) {$d['1']='31 октября';}
	if ($d['1']==11) {$d['1']='30 ноября';}
	if ($d['1']==12) {$d['1']='31 декабря';}
	return $d['1'].' '.$d['0'];
}
?>
<html>
...
if (strlen($data_schet)==0){ echo datetostring3($schetfactura_date->date);} else { echo $data_schet;}?>
 </td>
 <td align=left> (1)</td>
 </tr>
 <tr><td></td><td></td></tr>
 ...
 <td width=2100px> <b>Жеткiзyші <br />Поставщик</b>     <u><?php echo $org->org_name; ?></u>
  ...
  <tr>
 <td width=2100px> Свидетельство о постановке на регистрационный учет по НДС <u><?php echo $org->svidetelstvo_nds;?> </u></td>
 <td></td>
 </tr>
 <tr>
 ...
 <tr>
 <td width=2100px>Тауарлар (жұмыстар, қызметтер) жеткізуге арналған шарт (келісім-шарт)<br/>Договор(контракт) на поставку товаров (работ, услуг) №<u>   <?php echo $firm->dogovor."   </u> от <u>    ".datetostring($firm->dogovor_date).", ". $edit5; echo " ".$edit6;?></u></td>
 <td> (3)</td>
 </tr>
 <tr>
 ...
 <tr>
 <td width=2100px>Тауар-көлік жөнелтпе құжатты <br/>Товарно-транспортная накладная № <u><?php echo '0'.$schetfactura_date->schet_new.' от ';
if (strlen($data_schet)==0){ echo datetostring($schetfactura_date->date);} else { echo $data_schet;}?></u> </td>
 <td> (7)</td>
 <td> (7)</td>
 </tr>
 <tr>
...
<tr align="center">
	...
	<TD width="400px">электроэнергия <br/> за <?php echo datetostring2($schetfactura_date->date);?> года</td>
...
<br />
 ...
 <table width="100%">
 <tr>
 <td align="left"><b>Ұйымның басшысы <br/>Директор филиала: <?php  echo trim($org->director); ?></b></td>
 <td></td>
 ...
 <td></td>
 <td align="right"> <u>Ведущий инженер: Бодня М.А.</u></td>
 </tr>
  <tr>
 ...
 <tr>
 <td align="left"><b>Уполномоченный на подписание счета-фактуры<br/>за директора: Зам.директора по сбыту: Куркин Ю.Ю.</b></td>
 <td></td>
 <td align="right"><b>За гл.бухгалтера: <br/>бухгалтер-кассир: Гергенрейдер З.А.</b></td>
 </tr>
 <tr>
 <td align="left"> </td>
  <td align="center"></td>
